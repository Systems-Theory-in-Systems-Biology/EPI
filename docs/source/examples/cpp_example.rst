...
call C++ code from your python :py:class:`~epipy.core.model.Model` class.
...
* Performance Comparison: The file :file:`epipy/examples/cpp/python_reference_plants.py` includes
...
.. literalinclude:: ../../../epipy/examples/cpp/cpp_model.hpp
  :language: c++

Wrapping the C++ Code
_____________________

.. literalinclude:: ../../../epipy/examples/cpp/wrapper.cpp
  :language: c++
...
.. literalinclude:: ../../../epipy/examples/cpp/cpp_plant.py
    :language: python
