Temperature Model
-----------------
The temperature model is contained in :code:`epic/example_modelsapplications/temperature`.
...
* Additional fixed parameters: The model includes fixed parameters :code:`self.lowT=30.0` and :code:`self.highT=30.0`.
  These fixed parameters are passed to the forward function seperately. You can create models with different parameters by
  creating several model objects. Hower you should think about overwritting the method :py:meth:`epic.core.model.Model.getModelName()`
